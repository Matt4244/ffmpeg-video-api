...
OUTPUT_DIR = "output"
FONT_PATH = "/app/Poppins-Bold.ttf"
...
def render():
    ...
    try:
        ...
        cmd = [
            "ffmpeg", "-i", input_path,
            "-vf",
            f"drawbox=x=0:y=ih-160:w=iw:h=100:color=#C7A15C@1:t=fill, drawtext=fontfile={FONT_PATH}:text='{wrapped_text}':fontcolor=white:fontsize=36:x=(w-text_w)/2:y=h-125",
